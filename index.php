...
<body>
    <?php if ($auth["logged"]) : ?>
        <div class="popup-form text-center">
            <div class="popup-form-content">
                ...
                <form class="presentationForm mt-2">
                    ...
                    <input class="form-control" type="text" id="firt-name" name="firstname" pattern="^[A-Za-zÀ-ÖØ-öø-ÿ\s-]+$" title="Nome" placeholder="Nome *" required>

                    <label for="last-name"></label>
                    <input class="form-control" type="text" id="last-name" name="lastname" pattern="^[A-Za-zÀ-ÖØ-öø-ÿ\s-]+$" title="Sobrenome" placeholder="Sobrenome *">
                    ...
                    <div class="row mt-5">
                        <div class="col">
                            <button type="submit" class="submit-question-form btn btn-primary w-100">Salvar</button>
                        </div>
                        <div class="col">
                            <button type="submit" class="submit-question-form btn btn-danger w-100">Cancelar</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <script src="./public/js/script.js" Content-Type: application/javascript></script>   
    <?php else : ?>
